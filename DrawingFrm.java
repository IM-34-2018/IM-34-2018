	...
	public DrawingFrm() {
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(Shape shape : PnlDrawing.shapesArrList) {
					if(shape.isSelected()) {
						int ans = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the selected object?", "Warining",
		...
		btnAreaColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				area = JColorChooser.showDialog(null, "Chose a color", Color.WHITE);
				if (area == null) {
					area=Color.white;
				}
			}
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING, false)
							...
							.addComponent(btnPoint, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
						...
						.addComponent(btnDelete, GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
						.addComponent(btnOutlineColor, GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
						.addComponent(btnAreaColor, GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
					.addContainerGap())
		);
